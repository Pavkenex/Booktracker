        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">Genres ({{ filteredGenres.length }} total)</h5>
            </div>
            <div class="card-body">
              <!-- Loading State -->
              ...
              <div class="row" *ngIf="!loading">
                <div class="col-md-4 col-lg-3 mb-3" *ngFor="let genre of filteredGenres">
              ...
              <!-- Empty State -->
              <div class="text-center py-4" *ngIf="!loading && filteredGenres.length === 0">
                <i class="fas fa-tags fa-3x text-muted mb-3"></i>
                <h5>No genres found</h5>
                <p class="text-muted" *ngIf="searchTerm">
                  No genres match your search criteria. Try a different search term.
                </p>
                <p class="text-muted" *ngIf="!searchTerm">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">{{ isEditing ? 'Edit Genre' : 'Add New Genre' }}</h5>
            ...
            <div class="modal-body">
              <div class="mb-3">
                ...
                <div class="invalid-feedback">
                  Genre name is required and must be at least 2 characters long
                </div>
              </div>
              
              <div class="alert alert-info">
                <i class="fas fa-info-circle me-2"></i>
                <strong>Note:</strong> Genre names should be descriptive and unique. 
                Examples: Fiction, Non-Fiction, Science Fiction, Romance, Mystery, etc.
              </div>
            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="alert alert-warning">
              ...
              <strong>Warning:</strong> This action cannot be undone. You must first reassign all books 
              in this genre to other genres before deletion.
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
