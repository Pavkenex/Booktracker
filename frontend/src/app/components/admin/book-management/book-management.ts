            ...
            <div class="card-body">
              <div class="table-responsive" *ngIf="!loading">
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr *ngFor="let book of booksResponse?.content">
                      <td>{{ book.id }}</td>
                      <td>{{ book.title }}</td>
                      <td>{{ book.author }}</td>
                      ...
                      <td>
                        <span 
                          *ngFor="let genre of book.genres; let last = last"
              ...
              <!-- Empty State -->
              <div class="text-center py-4" *ngIf="!loading && (!booksResponse?.content || booksResponse?.content?.length === 0)">
              ...
              <!-- Pagination -->
              <nav *ngIf="booksResponse && booksResponse.totalPages > 1">
