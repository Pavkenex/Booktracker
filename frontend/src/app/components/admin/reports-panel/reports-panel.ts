            ...
            <div class="card-body">
              ...
              <div class="d-grid gap-2">
                <button
                  ...
                  >
                  @if (loadingReports['books-by-category']) {
                    <span class="spinner-border spinner-border-sm me-2"></span>
                  }
                  Generate Report
                </button>
                @if (reportData.booksByCategory) {
                  <div class="btn-group">
                    <button
            ...
            <div class="card-body">
              ...
              <div class="d-grid gap-2">
                <button
                  ...
                  >
                  @if (loadingReports['daily-activity']) {
                    <span class="spinner-border spinner-border-sm me-2"></span>
                  }
                  Generate Report
                </button>
                @if (reportData.dailyActivity) {
                  <div class="btn-group">
                    <button
                      class="btn btn-sm btn-success"
            ...
            <div class="card-body">
              ...
              <div class="d-grid gap-2">
                <button
                  ...
                  >
                  @if (loadingReports['user-engagement']) {
                    <span class="spinner-border spinner-border-sm me-2"></span>
                  }
                  Generate Report
                </button>
                @if (reportData.userEngagement) {
                  <div class="btn-group">
                    <button
                      class="btn btn-sm btn-success"
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      @for (item of reportData.booksByCategory; track item) {
                        <tr>
                          <td>{{ item.category }}</td>
                          <td>{{ item.count }}</td>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      @for (item of reportData.dailyActivity; track item) {
                        <tr>
        ...
        <div class="row mb-4">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  @for (metric of reportData.userEngagement; track metric) {
